...
public class SiegeEngine implements Cloneable {
    ...
    public Map<ItemStack, GunnersProjectile> projectiles = new HashMap<>();
    ...
    public SiegeEngine(@NotNull String name, @NotNull HashMap<ItemStack, GunnersProjectile> newProjectiles, @NotNull ItemStack fuelItem, int customModelID) {
        ...
        // set projectiles
        if (newProjectiles.keySet().isEmpty() || newProjectiles.isEmpty()) {
